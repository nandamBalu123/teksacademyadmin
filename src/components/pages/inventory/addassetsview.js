  ...
  return (
    <div className="container mt-3">
      ...
      <div className='assignassets-view'> 
              <h3 className='text-center my-3'> Assets View</h3>
             <div className='d-flex justify-content-evenly'> 
           <div> 
           <h5 className="mt-3"><b> Name: </b><span >{getassigndata.vendername}</span></h5>
           ...
           {/* <h5 className="mt-3">Brand Name: <span>{getassigndata.brandname}</span></h5> */}
             ...
             <NavLink to="/addassets"><button className='btn btn-primary mb-4 '> Back</button></NavLink>
             </div>
</div>
