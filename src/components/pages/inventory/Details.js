      ...
      <div className="assignassets-view">
        ...
        <div className="d-flex justify-content-evenly">
          <div>
            <h5 className="mt-3">
              <b> Name: </b>
              <span>{getassigndata.name}</span>
            </h5>
            <h5 className="mt-3">
              <b>Designation: </b> <span>{getassigndata.designation}</span>
            </h5>
            <h5 className="mt-3">
              <b> Branch: </b> <span>{getassigndata.branch}</span>
            </h5>
            <h5 className="mt-3">
              <b> Asset type:</b> <span>{getassigndata.assettype}</span>
            </h5>
            <h5 className="mt-3">
              {" "}
              <b> Issued Date:</b> <span>{getassigndata.issueddate}</span>
            </h5>
          ...
          <div>
            <h5 className="mt-3">
              {" "}
              <b>Brand Name:</b> <span>{getassigndata.brandname}</span>
            </h5>
            <h5 className="mt-3">
              {" "}
              <b>Asset Code :</b> <span>{getassigndata.assetcode}</span>
            </h5>
            <h5 className="mt-3">
              {" "}
              <b>Quantity :</b> <span>{getassigndata.anonymity}</span>
            </h5>
            <h5 className="mt-3">
              {" "}
              <b>Remarks :</b> <span>{getassigndata.remarks}</span>
            </h5>
