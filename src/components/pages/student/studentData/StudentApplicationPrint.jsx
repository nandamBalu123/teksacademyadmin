...
const PrintableComponent = React.forwardRef((props, ref) => {
  ...
  return (
    ...
    <div className="tc">
      <div> <h2 className="tclogo"> Terms & Conditions</h2></div> 
      <div className="info">
      ...
      <ul>
        ...
        <li>
          {" "}
          The eligibility criteria for each course will be clearly communicated
          to the students before admission, and students must provide all
          required documents and information during the admission process.
        </li>
        <li>
          {" "}
      ...
      <ul>
        ...
        <li>
          {" "}
          Fees for each course will be clearly communicated to the students
          before admission, and they are non-refundable except in case of course
          cancellation by the center or extenuating circumstances that prevent
          the student from continuing the course, in both the cases payment will
          be refunded after deductions.
        </li>
        <li>
          {" "}
          No course fee adjustment will be allowed from one course to another
          course.
        </li>
        <li>
          {" "}
          No course fee adjustment will be allowed from one student to another
          student
        </li>
        <li>
          {" "}
          Any request for course fee adjustment will not be entertained by the
          coaching center under any circumstances.
        </li>
        <li> All course fees are non-transferable and non-refundable.</li>
        <li>
          {" "}
          Students are advised to choose their courses carefully and make sure
          that they are fully committed to the course before paying the course
          fee.
        </li>
        <li>
          {" "}
          In case a student is unable to complete the course due to valid
          reasons, the course fee will not be refunded or adjusted against any
          other course.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          {" "}
          The course material and digital goods provided by the coaching center
          is copyrighted and cannot be reproduced or used for commercial
          purposes without permission.
        </li>
        <li>
          {" "}
          Any damage or loss of course material will be the responsibility of
          the student and may attract additional charges for extra material copy
          as per the center's policy.
        </li>
      </ul>
      <strong> 4. Attendance :</strong>
      <ul>
        <li>
          Regular attendance is essential for successfully completing the course
          and obtaining a certificate.
        </li>
        <li>
          {" "}
          Students must inform the center in advance if they are unable to
          attend a class due to valid reasons such as illness or emergencies.
        </li>
        <li>
          {" "}
          Make-up classes may be arranged at the discretion of the center and
      ...
      <ul>
        ...
        <li>
          {" "}
          The use of drugs or alcohol within the center's premises is strictly
          prohibited and may lead to immediate expulsion from the center.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          Students must adhere to the rules and regulations of the examination,
          and any deviation may lead to disqualification or cancellation of the
          examination.
        </li>
        <li>
          {" "}
      ...
      <ul>
        <li className="pt-5">
          The certificate will only be awarded to students who successfully
          complete the course as per the center's criteria.
        </li>
        <li>
          {" "}
          The certificate does not guarantee employment or acceptance into any
          institution.
        </li>
      </ul>
      ...
      <ul>
        <li>
          The center is not responsible for any injury, loss, or damage to the
          students or their belongings within the center's premises or during
          any offsite activity.
        </li>
        <li>
          {" "}
      ...
      <ul>
        <li>
          The center may revise its policies, rules and regulations, course
          structure, fees, timings, or any other aspect of the coaching center
          from time to time without prior notice to the students.
        </li>
        <li>
          {" "}
      ...
      <ul>
        ...
        <li>
          {" "}
          Any dispute arising out of or related to these terms and conditions
          shall be resolved amicably through mutual discussion and agreement
          between the coaching center and the student.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          completely depends on centers decision and on the duration of the
          course completed by the student and the center's policy.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          The center does not provide any placement guarantee to the students
          but may assist them in finding suitable job opportunities through
          guidance, counseling, and if any recommendations.
        </li>
      </ul>
      ...
      <ul>
        <li>
          {" "}
          Each student will be issued an identification card (ID card) by the
          coaching center, and it must be carried by the student at all times
          while attending classes or any other activities conducted by the
          center.
        </li>
      </ul>
      ...
      <ul>
        <li>
          Copying or distributing any of the coaching center's course material,
          including lectures, notes, presentations, or any other content, is
          strictly prohibited. Any violation of this rule may lead to immediate
          expulsion from the center and legal action may be taken against the
          student.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          center authorities, is not permitted. In case a student wishes to
          discontinue the course, they must inform the center in writing and
          complete all formalities as required.
        </li>
      </ul>
      <strong>16. Attendance and Absence:</strong>
      <ul>
        <li>
          Regular attendance is important for the successful completion of the
          course.
        </li>
      </ul>
      <ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          If a student is absent for 3 consecutive days without intimation,
          their admission may be terminated without refund.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          While the center will endeavor to provide training with a specific
          teaching staff, there is no commitment to do so.
        </li>
        <li>
          {" "}
      ...
      <ul>
        ...
        <li>
          {" "}
          The course fees may vary from student to student, based on their merit
          and other relevant factors as determined by the center.
        </li>
        <li>
          {" "}
          The center reserves the right to change the course fees at any time
      ...
      <ul>
        <li>
          {" "}
          The center reserves the right to update the course curriculum as per
          its requirements, without any prior notice to the students.
        </li>
        <li>
          {" "}
          Students are expected to keep themselves updated with any changes in
      ...
      <ul className="pt-5">
        <li>
          The course duration may vary from batch to batch, depending on factors
          such as students' attendance, training methodology, and other relevant
          factors as determined by the center.
        </li>
        <li>
          {" "}
          The center reserves the right to change the course duration at any
      ...
      <ul>
        ...
        <li>
          The coaching center will not guarantee any specific internship or job
          placement.
        </li>
        <li>
          The coaching center may charge a separate fee for providing internship
          support services.
        </li>
        <li>
          The coaching center will not be liable for any issues or disputes that
          arise between the student and the internship provider.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          The coaching center will provide practice projects to the students for
        ...
        <li>
          {" "}
          Students must complete the project within the given time frame and
          submit it to the center for evaluation.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          {" "}
          All intellectual property created by students during the live project
          or internship will belong to the student.
        </li>
        <li>
          {" "}
          The coaching center may use such intellectual property for promotional
      ...
      <ul>
        <li>
          {" "}
          We use the information collected to contact students regarding course
          updates, provide course materials, and issue certificates of
          completion.
        </li>
      </ul>
      ...
      <ul>
        <li>
          We do not share personal information with any third parties without
          the student's consent, except as required by law.
        </li>
      </ul>
      <strong> 4. Security:</strong>
      <ul>
        <li>
          We take reasonable measures to ensure the security of the personal
          information collected from students.
        </li>
      </ul>
      <strong> 5. Cookies:</strong>
      <li>  
      We use cookies on our website to track user behavior and improve the
          user experience. Students can disable cookies in their web browser if
      ...
      <ul>
        ...
        <li>
          ...
          course and related services, or until the student requests that their
      ...
      By enrolling in our coaching center, you acknowledge that you have read,
      understood, and agree to abide by our terms and conditions and privacy
      policy.
      <div className="sign">
