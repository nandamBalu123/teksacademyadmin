        ...
        <div className='container mt-3'>
            <div className='refundstatus mt-3'>
                ...
                <div className='row '>
                    <div className='col-7 mt-3'>
                        ...
                        {role && role === "accounts" && refund[0].status.level1.status === "Approved" && refund[0].status.level2.status === "Approved" && < div className='row'>
                            <div className='d-flex justify-content-evenly'>
                                ...
                                <button
                                    className={`btn ${refund[0].status.level3.status === "In-Progress" ? 'btn-primary' : 'bg-light'}`}
                                    onClick={() => handleStatusChange('level3', 'In-Progress')}
                                >
                                    In-Progress
                                </button>
                                <button
                                    className={`btn ${refund[0].status.level3.status === "Approved" ? 'btn-success' : 'bg-light'}`}
                                    onClick={() => handleStatusChange('level3', 'Approved')}
                                >
                                    Approved
                                </button>
                                <button
                    ...
                    <div className='col-5'> <ChatBox setRefund={setRefund} /></div>
                </div>
