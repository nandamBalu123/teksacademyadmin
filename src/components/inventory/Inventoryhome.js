...
export default function Inventoryhome() {
  ...
  return (
    ...
    <div className='container'>
      <div className='row'>
        <div className='col-2'>
        <NavLink to='/addassets' style={{textDecoration: 'none', padding: '5px 10px', background: '#0d6efd',
            color: 'white', borderRadius: '5px', margin: '10px auto', display: 'block', textAlign: 'center'}}>Add Assets</NavLink>
        <NavLink to='/assignassets' style={{textDecoration: 'none', padding: '5px 10px', background: '#0d6efd',
            color: 'white', borderRadius: '5px', margin: '10px auto', display: 'block', textAlign: 'center'}}>Assign Assets</NavLink>
        </div>
      </div>
      {/* <div className='row'>
