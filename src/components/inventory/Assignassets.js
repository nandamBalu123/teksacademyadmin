                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-3'>
                                <div className="mt-2 mb-2">
                                    <h4>Hitech City</h4>
                                    {/* <span>Rows : {getassigndata.length}</span><br></br> */}
                                    <span>Total laptops: <strong>{hcgetLaptopCount()}</strong></span><br></br>
                                    <span>Total t-shirt: <strong>{hcgetTshirtCount()}</strong></span><br></br>
                                    <span>Total shirt: <strong>{hcgetShirtCount()}</strong></span><br></br>
                                    <span>Total charger: <strong>{hcgetChargerCount()}</strong></span><br></br>
                                    <span>Total mouse: <strong>{hcgetMouseCount()}</strong></span><br></br>
                                    <span>Total bags: <strong>{hcgetStudentsBags()}</strong></span><br></br>
                            ...
                            <div className='col-lg-3'>
                                <div className="mt-2 mb-2">
                                    <h4>Ameerpet</h4>
                                    {/* <span>Rows : {getassigndata.length}</span><br></br> */}
                                    <span>Total laptops: <strong>{apgetLaptopCount()}</strong></span><br></br>
                                    <span>Total t-shirt: <strong>{apgetTshirtCount()}</strong></span><br></br>
                                    <span>Total shirt: <strong>{apgetShirtCount()}</strong></span><br></br>
                                    <span>Total charger: <strong>{apgetChargerCount()}</strong></span><br></br>
                                    <span>Total mouse: <strong>{apgetMouseCount()}</strong></span><br></br>
                                    <span>Total bags: <strong>{apgetStudentsBags()}</strong></span><br></br>
                            ...
                            <div className='col-lg-3'>
                                <div className="mt-2 mb-2">
                                    <h4>Dilsukhnagar</h4>
                                    {/* <span>Rows : {getassigndata.length}</span><br></br> */}
                                    <span>Total laptops: <strong>{dngetLaptopCount()}</strong></span><br></br>
                                    <span>Total t-shirt: <strong>{dngetTshirtCount()}</strong></span><br></br>
                                    <span>Total shirt: <strong>{dngetShirtCount()}</strong></span><br></br>
                                    <span>Total charger: <strong>{dngetChargerCount()}</strong></span><br></br>
                                    <span>Total mouse: <strong>{dngetMouseCount()}</strong></span><br></br>
                                    <span>Total bags: <strong>{dngetStudentsBags()}</strong></span><br></br>
