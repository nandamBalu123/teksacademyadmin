...
const Register = () => {
    ...
    const addinpdata = async (e) => {
        ...
        const { name, vendername, designation, branch, assettype, brandname, issueddate, assetcode, anonymity, remarks } = inpval;
        ...
        // } 
            ...
            const res = await fetch(`${apiUrl}/assignasset`, {
                ...
                body: JSON.stringify({
                    name,vendername, designation, branch, assettype,brandname, issueddate, assetcode, anonymity, remarks
                })
            });
                ...
                <form className="mt-4">
                    <div className="row">
                        ...
                        <div class="mb-3 col-lg-6 col-md-6 col-12">
                            ...
                            <input type="number" value={inpval.anonymity} onChange={setdata} name="anonymity" class="form-control" id="exampleInputPassword1" />
                        </div>
                        {/* <div class="mb-3 col-lg-6 col-md-6 col-12">
